 ...
 private class ButtonListener implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e){
   ...
   if (b.getText().equals("New Layer")){
    ...
    String str = inputs.get(inputs.size()-1);
    String scales = str.split("\\s+")[0];
    String redc = str.split("\\s+")[1];
    String greenc = str.split("\\s+")[2];
    String bluec = str.split("\\s+")[3];
    System.out.println(str + " " + scales +" " + redc + " " + greenc + " " + bluec);
    size.setValue((int)(Double.parseDouble(scales)*100.0));                      
    red.setValue(Integer.parseInt(redc));
    green.setValue(Integer.parseInt(greenc));
    blue.setValue(Integer.parseInt(bluec));
